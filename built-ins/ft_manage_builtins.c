...
int	is_builtin(char **comands)
{
	if (!strncmp(comands[0], "echo\0", 5))//probar a poner echooooo
		return (1);
	else if (!strncmp(comands[0], "cd\0", 3))
		return (1);
	else if (!strncmp(comands[0], "pwd\0", 4))
		return (1);
	else if (!strncmp(comands[0], "export\0", 7))
		return (1);
	else if (!strncmp(comands[0], "unset\0", 6))
		return (1);
	else if (!strncmp(comands[0], "env\0", 4))
		return (1);
	else if (!strncmp(comands[0], "exit\0", 5))
		return (1);
	return (0);
}
